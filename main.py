from apresentacao.comando import Sair, CriarAlaComTamanhoFixo, AdicionarPacienteEmUmLeitoDaAla, RelatorioDeAla, RealocarPaciente, RemoverPaciente
...
def main():
    ...
    menu.adicionar_comando(7, RemoverPaciente())
